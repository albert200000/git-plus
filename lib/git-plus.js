...
import git from "./git.coffee";
import configurations from "./config.coffee";
import { initializeContextMenu } from "./context-menu";
import service from "./service.coffee";
import gitAdd from "./models/add";
import gitAddModified from "./models/add-modified";
import GitPaletteView from "./views/git-palette-view.coffee";
import * as treeViewCommands from "./models/tree-view";
import GitCheckoutNewBranch from "./models/git-checkout-new-branch.coffee";
...
import GitCherryPick from "./models/git-cherry-pick.coffee";
import GitCommit from "./models/git-commit.coffee";
import GitCommitAmend from "./models/git-commit-amend.coffee";
import GitDiff from "./models/git-diff.coffee";
import GitDiffBranches from "./models/git-diff-branches.coffee";
import GitDiffBranchFiles from "./models/git-diff-branch-files.coffee";
import GitDifftool from "./models/git-difftool.coffee";
import GitDiffAll from "./models/git-diff-all.coffee";
import gitFetch from "./models/fetch";
import gitFetchInAllRepos from "./models/fetch-in-all-repos";
import GitInit from "./models/git-init.coffee";
import GitLog from "./models/git-log.coffee";
import gitPull from "./models/pull";
import gitPush from "./models/push";
import GitRemove from "./models/git-remove.coffee";
import GitShow from "./models/git-show.coffee";
import GitStageFiles from "./models/git-stage-files.coffee";
import GitStageHunk from "./models/git-stage-hunk.coffee";
import ManageStashes from "./models/manage-stashes";
import GitStashApply from "./models/git-stash-apply.coffee";
import GitStashDrop from "./models/git-stash-drop.coffee";
import GitStashPop from "./models/git-stash-pop.coffee";
import GitStashSave from "./models/git-stash-save.coffee";
import GitStashSaveMessage from "./models/git-stash-save-message.coffee";
import GitStatus from "./models/git-status.coffee";
import GitTags from "./models/git-tags.coffee";
import GitRun from "./models/git-run.coffee";
import GitMerge from "./models/git-merge.coffee";
import GitRebase from "./models/git-rebase.coffee";
import GitOpenChangedFiles from "./models/git-open-changed-files.coffee";
